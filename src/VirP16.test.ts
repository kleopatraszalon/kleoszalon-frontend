...
describe('VIR P16 Executive Intelligence 2.0',()=>{
 ...
 it('places P1-P16 in a dedicated localized VIR Intelligence sidebar group',()=>{for(let i=1;i<=16;i++)expect(sidebar).toContain(`/admin/vir/p${i}`);for(const x of ['VIR intelligencia','VIR Intelligence','Üzleti intelligencia','Bevételi autopilóta','Revenue Autopilot','Vezetői intelligencia','Executive Intelligence'])expect(sidebar).toContain(x);for(const x of ['Marketing Automation P9','Revenue Autopilot P10','AI Reception & Journey P11','Customer Journey P12','Revenue Protection P13','Operations Autopilot P14','Executive Autopilot P15','Executive Intelligence P16'])expect(sidebar).not.toContain(x)});
