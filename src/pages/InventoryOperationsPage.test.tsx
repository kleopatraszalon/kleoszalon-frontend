...
describe("Inventory operations v4 workspace",()=>{const page=fs.readFileSync(path.join(process.cwd(),"src/pages/InventoryOperationsPage.tsx"),"utf8");const routes=fs.readFileSync(path.join(process.cwd(),"src/routing/inventoryRoutes.tsx"),"utf8");const pages=fs.readFileSync(path.join(process.cwd(),"src/routing/routePages.ts"),"utf8");
 ...
 test("route is wired into application",()=>{expect(pages).toContain("InventoryOperationsPage");expect(routes).toContain('/warehouse/operations')});
});
