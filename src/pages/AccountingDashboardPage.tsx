...
export default function AccountingDashboardPage(){
  return <div style={{padding:'24px',maxWidth:1600,margin:'0 auto'}}>
    <header style={{display:'flex',alignItems:'center',gap:14,marginBottom:18}}>
      ...
      <div><div style={{fontSize:12,fontWeight:900,letterSpacing:'.08em',color:'#7a6b5e'}}>KÖNYVELÉS</div><h1 style={{margin:'2px 0 0',fontSize:28}}>Könyvelési irányítópult</h1><p style={{margin:'5px 0 0',color:'#667085'}}>Pénzügyi adatok, bizonylatok, zárások és archivált munkalapok egy helyen.</p></div>
    </header>
