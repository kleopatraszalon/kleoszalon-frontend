...
describe('VIR P11 AI Reception & Customer Journey 3.0',()=>{
 ...
 it('keeps booking and compensation controlled',()=>{expect(page).toContain('Automatikus foglalás, pénzvisszatérítés vagy kompenzáció nincs.');expect(page).toContain('Automatikus kompenzáció és pénzvisszatérítés: NEM.');expect(page).toContain('kind="work-orders"');});
