...
const ClientDuplicateReviewPage = lazy(
  () => import("./pages/ClientDuplicateReviewPage"),
);
const ClientFormsVersionPage = lazy(
  () => import("./pages/ClientFormsVersionPage"),
);
...
const router = createBrowserRouter([
  ...
  { path: "/modules/customers/forms", element: A(<ClientFormsVersionPage />) },
  {
    path: "/modules/customers/duplicate-review",
    element: A(<ClientDuplicateReviewPage />),
  },
...
export default function App() {
  return (
    <Suspense fallback={<div style={{ padding: "2rem" }}>Betöltés…</div>}>
