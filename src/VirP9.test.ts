...
describe('P9 Marketing & Communication Automation',()=>{
 ...
 it('links P9 from manager cockpit and keeps current route invariant',()=>{expect(cockpit).toContain('/admin/vir/p9');expect(cockpit).toContain('Marketing automatizálás P9');expect(audit).toContain('routeMatches.length!==200');});
});
