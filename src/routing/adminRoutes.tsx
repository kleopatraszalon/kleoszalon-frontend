...
import {
  ...
  VirP17Page, VirP18Page, VirP19Page,
...
export const adminRoutes: RouteObject[] = [
  ...
  { path: "/admin/vir/p17", element: R(MANAGEMENT, <VirP17Page />) },
  { path: "/admin/vir/p18", element: R(MANAGEMENT, <VirP18Page />) },
  { path: "/admin/vir/p19", element: R(MANAGEMENT, <VirP19Page />) },
