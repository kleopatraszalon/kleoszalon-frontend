...
export default function CopyrightNotice({ inline = false }: CopyrightNoticeProps) {
  ...
  if (!inline && (isLogin || !sidebarVisible)) return null;
    ...
    <>
      <button
        ...
        style={inline ? {
          ...
          left: 12,
          bottom: 8,
          width: "calc(var(--sidebar-width, 270px) - 24px)",
          padding: 0,
          border: 0,
          background: "transparent",
          color: "#b9aa8d",
      ...
      >
        ...
        <span style={{ display: "block", marginTop: 2, textDecoration: "underline", textUnderlineOffset: 2, opacity: 0.9 }}>
      ...
      {open && (
        <div
          ...
          style={{ position: "fixed", inset: 0, zIndex: 5000, display: "grid", placeItems: "center", padding: 18, background: "rgba(10,12,18,.62)", backdropFilter: "blur(5px)" }}
        >
          <section role="dialog" aria-modal="true" aria-labelledby="copyright-title" style={{ width: "min(820px, 96vw)", maxHeight: "88vh", overflow: "auto", borderRadius: 18, background: "#fff", boxShadow: "0 26px 80px rgba(0,0,0,.3)", color: "#2f3440" }}>
            ...
            <div style={{ padding: "22px", fontSize: 14, lineHeight: 1.65 }}>
              ...
              <div style={{ marginTop: 22, paddingTop: 16, borderTop: "1px solid #eceef2", fontWeight: 800, textAlign: "center" }}>© 2026 Kleopátra2003 Kft. · Minden jog fenntartva.</div>
            </div>
          </section>
        </div>
      )}
