...
export default function Sidebar({user}:SidebarProps){
 ...
 const visible=useMemo(()=>{const base=isCustomer?CUSTOMER:isAccounting?ACCOUNTING:isLocationScoped?LOCATION:isStaff?STAFF:menus;if((isAdmin||isManager)&&!base.some(x=>x.route===SPEC_PARITY.route))return[...base,SPEC_PARITY];return base},[isCustomer,isAccounting,isLocationScoped,isStaff,isAdmin,isManager,menus]);
