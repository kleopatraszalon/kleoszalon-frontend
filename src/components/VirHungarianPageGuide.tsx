...
const VIR_ENGLISH_GUIDES: Record<GuideKey, GuideDefinition> = {
  ...
  p3:{title:"Revenue and retention intelligence",purpose:"Analyzes churn risk, expected next visits, pricing suggestions and membership potential to improve retention and revenue per customer.",features:["Churn radar","Next visit","Smart pricing","Membership opportunities"]},
  "revenue-leakage":{title:"Revenue leakage monitor",purpose:"Finds points where booked or delivered services generate less revenue than expected so hidden losses can be identified and corrected.",features:["Deviations","Lost revenue","Corrective opportunities"]},
  p4:{title:"Operations intelligence",purpose:"Optimizes workforce, shifts, staff revenue, service portfolio and cross-salon overlap to achieve better output from the same capacity.",features:["Workforce optimizer","Smart shift planning","Staff revenue coach","Service portfolio","Cannibalization monitoring"]},
  p5:{title:"Advanced executive intelligence",purpose:"Provides business simulation, goal-to-action planning, pre-execution impact checks, competitive analysis and expansion analysis for evidence-based management decisions.",features:["Digital twin","Goal-to-action plan","Action preview","Competitive position","Location expansion"]},
...
export function VirHungarianPageGuide({ page, children }: { page: GuideKey; children: ReactNode }) {
  ...
  return <div className="vir-hu-intelligence-page">
    <style>{`
      ...
      .vir-hu-intelligence-page > .vir-management-page.p4-page > .p4-hero .p4-hero-copy{display:none}
      ...
      .vir-hu-intelligence-page > .vir-management-page .vir-tabs,
      .vir-hu-intelligence-page > .vir-management-page .p4-tabs{display:flex;gap:8px;flex-wrap:wrap;margin:0 0 18px;padding:0;border:0;background:transparent}
      .vir-hu-intelligence-page > .vir-management-page .vir-tabs button,
      .vir-hu-intelligence-page > .vir-management-page .p4-tabs button{min-height:40px;border:1px solid #d8dee9;border-radius:10px;background:#fff;padding:8px 12px;color:#475569;font-weight:800;cursor:pointer;box-shadow:none}
      .vir-hu-intelligence-page > .vir-management-page .vir-tabs button.is-active,
      .vir-hu-intelligence-page > .vir-management-page .p4-tabs button.is-active{border-color:#172033;background:#172033;color:#fff}
      .vir-hu-intelligence-page > .vir-management-page .p4-tabs button span{color:inherit}
      .vir-hu-intelligence-page > .vir-management-page .p4-tabs button small{display:block;color:inherit;opacity:.72}
    `}</style>
