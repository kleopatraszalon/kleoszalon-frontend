const PAGE_NAMES: Record<string, string> = {
  ...
  "/admin/vir": "VIR",
  "/admin/vir/cockpit": "VIR",
  "/admin/vir/actions": "VIR",
  "/admin/vir/intelligence": "VIR",
  "/admin/vir/p1": "VIR",
  "/admin/vir/p2": "VIR",
  "/admin/vir/p3": "Bevétel- és vendégmegtartási intelligencia",
  "/admin/vir/p3/revenue-leakage": "Bevételszivárgás-figyelő",
  "/admin/vir/p4": "Működési intelligencia",
  "/admin/vir/p5": "Fejlett vezetői intelligencia",
  "/admin/vir/p6": "VIR",
  "/admin/vir/p7": "VIR",
  "/admin/vir/p8": "VIR",
  "/admin/vir/p9": "VIR",
